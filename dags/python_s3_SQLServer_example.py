...
This dag truncates any existing tables in the staging schema, then creates a table for any file found in the s3 bucket.
"""
...
with DAG(
    ...
    truncate_staging = MsSqlOperator(
        task_id="truncate_staging",
        mssql_conn_id="cdw-dev",
